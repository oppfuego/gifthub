    ...
    <div className="terms-conditions">
      ...
      <main className="definitions">
        ...
        <div className="definitions-parent">
          <h1 className="definitions1">
            <p className="definitions2">
              1. Definitions
            </p>
          </h1>
          <div className="definitions-content">
            <div className="definitions-sub-content">
            ...
            <div className="definitions-sub-content1">
            ...
            <div className="definitions-sub-content2">
        ...
        <div className="general-provisions-parent">
          <h1 className="general-provisions">
            <p className="general-provisions1">
        ...
        <Usage
          useOfGiftCards=" 3. Use of Gift Cards"
        ...
        <div className="purchase">
          <h1 className="purchase-of-gift-container">
            <p className="purchase-of-gift-cards">
          ...
          <div className="channels">
            ...
            <div className="channels-details1">
            ...
            <div className="channels-details2">
            ...
            <div className="channels-details3">
            ...
            <div className="channels-details4">
        ...
        <Usage
            ...
            giftCardsAreNonTransferab=
                "[Your Company] is not responsible for lost or stolen gift cards.
                Lost or stolen cards will not be replaced or refunded. Users should treat
                their gift cards like cash and take appropriate measures to safeguard them."
            expiration=
                "5.2 Safeguarding"
            giftCardsDoNotExpireHowev=
            "Users should keep their gift cards in a safe place and not share the card number or security
             code with anyone. If a gift card is lost or stolen, users should report it immediately to
              customer support, although replacement or refund cannot be guaranteed."
        />
        ...
        <Usage
            ...
            redemption=
                "6.1 No Cash Refunds"
            giftCardsAreNonTransferab=
                "Gift cards cannot be returned or exchanged for cash, except as required by law. Once purchased, all sales of gift cards are final. Users should ensure that they understand this policy before making a purchase."

            expiration=
                "6.2 Merchant Returns"
            giftCardsDoNotExpireHowev=
        ...
        <Usage
            ...
            redemption=
                "7.1 Compliance"
            giftCardsAreNonTransferab=
                "Users must use the gift cards and website in compliance with all applicable laws and regulations. Any use of the gift cards or website that violates these terms and conditions or any applicable law is strictly prohibited."
        ...
        <Usage
            useOfGiftCards="8. Privacy"
            redemption="8.1 Data Collection"
            ...
            expiration="8.2 Consent"
            giftCardsDoNotExpireHowev="By using our website and purchasing our gift cards, you consent to the collection and use of your information as outlined in our [Privacy Policy]. If you do not agree with our Privacy Policy, you should not use our website or purchase our gift cards."

        />
        <Usage
          useOfGiftCards="9. Limitation of Liability"
          redemption="9.1 Indirect Damages"
          giftCardsAreNonTransferab="[Your Company] is not responsible for any indirect, incidental, or consequential damages arising from the use or inability to use the gift cards or website. This includes, but is not limited to, damages for loss of profits, business interruption, or loss of data."
          expiration="9.2 Maximum Liability"
          giftCardsDoNotExpireHowev="[Your Company]'s liability for any claim related to the purchase or use of a gift card is limited to the amount of the gift card. In no event shall [Your Company]'s total liability to you for all damages, losses, and causes of action exceed the amount paid by you for the gift card."

        />
        <Usage
          useOfGiftCards="10. Amendments"
          redemption="10.1 Right to Amend"
          giftCardsAreNonTransferab="[Your Company] reserves the right to amend these terms and conditions at any time. Any changes will be posted on this page and will take effect immediately upon posting. Users should review these terms and conditions periodically to ensure that they are aware of any changes."
          expiration="10.2 User Responsibility"
        ...
        <div className="law">
          <h1 className="governing-law1">
            <p className="governing-law2">
              11. Governing Law
            </p>
          </h1>
          <div className="jurisdiction">
            <div className="jurisdiction-content">
              <h3 className="jurisdiction1">11.1 Jurisdiction</h3>
